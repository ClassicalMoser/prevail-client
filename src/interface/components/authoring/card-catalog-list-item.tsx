  ...
  return (
    <div class="group/thumb relative flex w-fit max-w-full flex-col gap-2 overflow-visible">
      <Show
        ...
        fallback={
          <div class="bg-muted text-muted-foreground flex aspect-5/7 w-16 items-center justify-center rounded-md border border-dashed text-center text-[0.6rem] leading-tight sm:w-[4.5rem]">
            No art yet
          </div>
        }
      >
      ...
      <div class="flex max-w-[4.5rem] flex-col gap-1">
        <Badge
